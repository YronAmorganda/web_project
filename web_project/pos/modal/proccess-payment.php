      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" id="change-amount" name="change"  class="form-control" readonly>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
          <button type="button" data-href="../pos/receipt/?order_id=<?php echo $_SESSION['order_id']; ?>"  class="btn btn-primary"  id="proceed-payment-btn">
              Proceed Payment
